...
if __name__ == '__main__':
    ...
    parser.add_argument('--name', type=str, default='0114-dilated-lr_policy-nearest-scale-larger_channel')
    parser.add_argument('--dataroot', type=str, default='../../SubdivDataset/HumanSeg-256-aug10')
